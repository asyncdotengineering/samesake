...
// same numbers reproduce offline from a fixture. The service (makeEvaluateEnrichService) only
// reads `enriched` rows from Postgres and hands them to the scorer.
