...
genuinely black products. `enrich.enrich()` builds surfaces, embeds the dense ones, and writes the vectors back — see [Pipeline lifecycle](/guides/pipeline-lifecycle/#enrich-writes-surfaces-and-optional-vectors).
