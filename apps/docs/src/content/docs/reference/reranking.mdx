...
- **Calibration** — `0.5` is calibrated for `gemini-embedding-2` on a labelled positive/negative probe (positives mean cosine ≈0.60, negatives ≈0.46). Recalibrate per embedding model; absolute thresholds drift with the model and corpus.
