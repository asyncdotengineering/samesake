...
| `generate` | `GenerateFn` | Optional | Enrich stages, NLQ, judge, `fashionRerank` |
...
Used by enrich pipelines, NLQ, the [relevance judge](/reference/relevance-judge/), and [`fashionRerank`](/reference/reranking/).
...
const matcher = createMatcher({
  ...
  rerank: fashionRerank(geminiGenerate, { model: "gemini-3.1-flash-lite" }),
});
```
...
- [Reranking](/reference/reranking/) — wire a remote `RerankFn` or `fashionRerank`
